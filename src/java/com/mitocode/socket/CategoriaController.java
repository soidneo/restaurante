...
import com.mitocode.socket.util.JsfUtil;
import com.mitocode.socket.util.JsfUtil.PersistAction;
import com.mitocode.bean.CategoriaFacade;
...
public class CategoriaController implements Serializable {
    ...
    @EJB
    private com.mitocode.bean.CategoriaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle3").getString("CategoriaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle3").getString("CategoriaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle3").getString("CategoriaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
